...
#5: VertexSystem.cpp file (without cpp)
###

mkdir $1
cp src/$5.cpp src/VertexSystem.h src/vertex_3steps.cpp src/plotOps_loop.py 'param_files/'$2'.vp' 'param_files/'$3'.vp' 'param_files/'$4'.vp' $1

cd $1
g++ -O2 -std=c++11 -c $5.cpp
g++ -O2 -std=c++11 -c vertex_3steps.cpp
g++ -o vertex vertex_3steps.o $5.o
