...
cd $1
g++ -std=c++11 -c VertexSystem.cpp -pg
g++ -std=c++11 -c vertex_cmm.cpp -pg
g++ -o vertex vertex_cmm.o VertexSystem.o -pg
./vertex $1 $2 $3 $4 #>$1'.log' 
gprof vertex gmon.out >profile.out
#sleep 20

#python plotOps_loop.py -i $1'_moved_' -s 0 -e "$(($3 / $4))" #-v 1
